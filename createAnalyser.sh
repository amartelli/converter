...
sed -e 's;ANALYSER_TEMPL;'${ananame}';g' < $src/ANALYSER_TEMPL.h > /afs/cern.ch/work/j/jkiesele/DeepLearning/DomAdapt/converter/interface/${ananame}.h
sed -e 's;ANALYSER_TEMPL;'${ananame}';g' < $src/ANALYSER_TEMPL.cpp > /afs/cern.ch/work/j/jkiesele/DeepLearning/DomAdapt/converter/src/${ananame}.cpp
sed -e 's;ANALYSER_TEMPL;'${ananame}';g' < $src/ANALYSER_TEMPL_EXEC.cpp > /afs/cern.ch/work/j/jkiesele/DeepLearning/DomAdapt/converter/bin/${ananame}.cpp
