...
void drawHistos(){
  ...
  //names.push_back("TTBHad");
  //names.push_back("TTBcms");
  //names.push_back("TTB_DAvd0x2");
  //names.push_back("TTBcms");
  //names.push_back("TTBatl");
  //names.push_back("QCD");
  //names.push_back("QCD_DAvd0x2");
  names.push_back("QCDcms");
  names.push_back("QCDatl");
  ...
  for(int ij=0; ij<2; ++ij){
    ...
    for(int io=0; io<11; ++io){
      histo[ij][io] = (TH1D*)inF[ij]->Get(("d_samples/"+nameH.at(io)).c_str());
      ...
      histo_b[ij][io] = (TH1D*)inF[ij]->Get(("d_samples/"+nameH.at(io)+"_b").c_str());
      ...
      histo_c[ij][io] = (TH1D*)inF[ij]->Get(("d_samples/"+nameH.at(io)+"_c").c_str());
      ...
      histo_l[ij][io] = (TH1D*)inF[ij]->Get(("d_samples/"+nameH.at(io)+"_l").c_str());
